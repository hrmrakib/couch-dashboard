...
export default function SignUp() {
  ...
  return (
    <div className='min-h-screen bg-[url("/auth/bg.png")] bg-cover bg-center flex items-center justify-center p-4'>
      ...
      <div className='bg-[#FFFFFF] rounded-lg p-8 w-full max-w-md shadow-lg'>
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          ...
          <button
            type='submit'
            className='w-full flex justify-center py-2 px-4 border border-transparent rounded-full shadow-sm text-sm font-medium text-white bg-[#2c2c2c] hover:bg-[#1a1a1a] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black'
          >
            Sign Up
          </button>
        </form>
